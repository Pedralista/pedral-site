    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-background px-6 text-center">
      ...
      {purchase?.items[0]?.item_name && (
        <div className="mt-16 max-w-[440px] border-t border-accent/[0.08] pt-8">
          <p className="text-[15px] font-light leading-[1.8] text-foreground-muted/70">
            Your {purchase.items[0].item_name} is one of twenty. The next step is one of one.
          </p>
          <Link
            href="/bespoke-pieces"
            className="mt-3 inline-block text-[14px] font-normal tracking-[1px] text-accent underline underline-offset-2 hover:text-accent-hover"
          >
