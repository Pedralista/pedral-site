...
export const collections: Collection[] = [
  {
    ...
    tagline: "Q2 2026",
    hook: "The Maestro, taken one step further.",
    description:
    ...
    image: "/images/maestro-ps-solaire.png",
    heroImage: "/images/maestro-ps-solaire.png",
    detailImage: "/images/maestro-ps-solaire.png",
    galleryImages: [
      "/images/maestro-ps-solaire.png",
    ],
    isPreOrder: true,
    hidden: true,
    variants: [
